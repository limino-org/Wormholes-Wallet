export default {
  ...
  generateNFT: {
    ...
    promptWordNotNull:"The prompt word/sourceUrl cannot be empty",
    normalNftTip:"You have checked AI painting, please fill in valid prompt words, enter up to 75 words, only English is supported slang and special symbols.",
    ...
    aiDrawTip:"Note that you will pay for the AI drawing when it is turned on.",
    emailTip:"The email will receive the AI NFT generated by WormholesChain for you."
  ...
  createExchange: {
    ...
    convert: "Convert",
    desc3: "This the button that you can convert your SNFT to ERB with Wormholes Blockchain.",
  ...
  receiveRewards: {
    ...
    tiptit3: "Get ERBs:",
    tip1: "SNFTs obtained during the official Wormholes event will be displayed on this page. You can click the “claim” button to get all the SNFTs in one click, and the SNFTs will be deposited directly into your current wallet.{br}You can operate your right and interests through the NFT trading centre in the lower right corner.",
