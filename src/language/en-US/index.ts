export default {
  ...
  import: {
    ...
    announcement: 'The imported account is viewable in your wallet but cannot be retrieved through the Erbie mnemonic.',
  ...
  mnemonic: {
    ...
    yourRecoveryPhraseTitle:
      "Under no circumstances will Erbie ask for your recovery phrase. Protect your funds and do not share your recovery phrase with anyone.",
